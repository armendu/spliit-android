...
// to know what to look for — and which Scripts/record-fixtures.mjs reads to know which group
// to record from. Recording responses lives there, not here: one seeder, one recorder.
